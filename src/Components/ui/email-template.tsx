    ...
    >
      ...
      <div style={{ padding: "20px", backgroundColor: "#ffffff" }}>
        ...
        <p style={{ fontSize: "16px", color: "#333333", marginBottom: "20px" }}>
          We’ve received your order (Transaction ID: <strong>{transactionId}</strong>) 
          associated with <strong>{email}</strong>. Below are the details of your purchase:
        </p>
        ...
        >
          {Object.entries(cartdata.cart as unknown as NumberRecord).map(([ele, idx]) => (
            <li
              key={ele}
              style={{
                display: "flex",
...
/>
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: "14px", color: "#555555", margin: "0 0 5px" }}>
        ...
        >
          <p style={{ fontSize: "16px", fontWeight: "bold", color: "#1a1a1a", margin: 0 }}>
      ...
      >
        ...
        <p style={{ margin: 0 }}>
          © 2025 Scents. All rights reserved.
        </p>
      </div>
    </div>
    </form>
